    ...
    return (
      <div className={`about`} id="about">
          <div className="container reveal">
            ...
            <p className="about-text">I began to code in 2021 and started by learning HTML, CSS, Javascript, React and Git/Github. Since learning to code, I have always enjoyed the process of problem solving and the feeling a sense of achievement when you manage to solve the outcome you were working towards.</p>
